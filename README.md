...
1. Log in to the AWS account where you wish to deploy the service.

2. Create a new Cloudformation stack, using the *contact-surveys-amazon-connect.yaml* template located in the *deployment* directory.
...
4. Proceed with the the stack creation steps.
...
5. Once the stack is deployed, in the **Output** tab, note the value of the **AdminUser** and the URL of the application.

6. Navigate the the URL noted at step 8. Log in to the application with the *Username* collected at step 8, and the *password* received during the stack deployment.

**Note:** You will be required to change your password at first login.

7. If you see the following screen, the solution has been successfully deployed and you are good to go.
